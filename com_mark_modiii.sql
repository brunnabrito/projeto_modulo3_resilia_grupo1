-- Database: Trabalho_marketing_IIIMODdados

-- DROP DATABASE IF EXISTS "Trabalho_marketing_IIIMODdados";

CREATE DATABASE "Trabalho_marketing_IIIMODdados"
    WITH 
    OWNER = postgres
    ENCODING = 'UTF8'
...
--POPULAR UMA TABELA - ADICIONAR DADOS
...
--EXCLUIR UMA TABELA
DROP TABLE Comercial CASCADE 

--VIZUALIZAR UMA TABELA COMPLETA
